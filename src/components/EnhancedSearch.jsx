...
import { useUserPreferencesStore } from '../utils/userPreferences/store';
...
export default function EnhancedSearch({ 
  ...
  const performSearch = async () => {
    ...
    try {
      ...
      // Add premium access information (simplified for free-only content)
      results = results.map(article => ({
        ...article,
        canAccess: true, // All content is now accessible
        requiresUpgrade: false, // No upgrade needed
      }));
    ...
    >
      <View style={{ 
        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20 }}>
          ...
          {/* Access Level - Simplified to only show all/free since there's no premium */}
          <View style={{ marginBottom: 24 }}>
            <Text
              style={{
                fontSize: 18,
