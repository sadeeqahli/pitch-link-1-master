...
export default function NewsScreen() {
  ...
  // Load content on mount (remove subscription loading)
  useEffect(() => {
  ...
  // Get content (always show free content now)
  const displayContent = getFreeContent();
...
Would you like to read the full article?`,
  ...
  return (
    <View style={{ flex: 1, backgroundColor: isDark ? "#0A0A0A" : "#F8F9FA" }}>
      ...
      >
        {/* Remove premium live streaming section */}
