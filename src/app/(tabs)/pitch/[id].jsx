...
export default function PitchDetailsScreen() {
  ...
  const getContiguousSlots = (startTime) => {
    ...
    // Limit max duration to 2 hours instead of 3
    const maxDuration = Math.min(2, 21 - startHour); // Max 2 hours or until 9 PM
              ...
              {availableDurations.map((duration) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Remove duration discount text */}
                    {false && duration > 1 && durationPricing.durationDiscount > 0 && (
                      <Text
                        style={{
                          fontSize: 12,
                          fontFamily: "Inter_500Medium",
